							...
							get: {
								...
								callback: function(objs) {
									...
									$.each(objs, function(i, obj) {									
										...
										// Convert the LatLng object to array
										var post_latlng = $.map(obj.position, function(value, index) {
											return [value];
										});
