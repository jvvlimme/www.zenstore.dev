    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            ...
            <div class="cart-collaterals">
                ...
                <input type="submit" class="button update-button" name="update_cart" value="<?php _e( 'Update Cart', 'commercegurus' ); ?>" /> 
                <input type="submit" class="button checkout-button " name="proceed" value="<?php _e( 'Proceed to Checkout', 'commercegurus' ); ?>" />
